export default class Game {
	...
	_init() {
		...
		this.gameArea.addEventListener('click', this._listenClickonGameArea.bind(this));
		// клик при победе в игре
		this.btn.addEventListener('click', this._listenClickonGameWin.bind(this));
		// клик на рестарт
		this.restartGame.addEventListener('click', this._listenClickonRestart.bind(this));
	}
	...
	_listenClickonGameArea(e) {
		...
		if (((idOfEmptyCell - idOfCell == 1) && idOfEmptyCell !== 6 && idOfEmptyCell !== 3) || ((idOfCell - idOfEmptyCell == 1) && idOfEmptyCell !== 2 && idOfEmptyCell !== 5) || (idOfEmptyCell - idOfCell == 3) || (idOfCell - idOfEmptyCell == 3)) {
